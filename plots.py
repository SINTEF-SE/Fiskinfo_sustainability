...
from utility import norsk_length_group
...
def createPlots(result, kpiData, text, cb, toPdfFile, toJsonFile, toCsvFile):
        figList = []
        jsonCsvDataList = []
        ...
        #jsonDict = createJsonItem(kpiData, result["nVessels"], result["periods"], result["kpi"])
